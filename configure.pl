...
#																					#
# Set installation directory of GMXSMDF to your unzipped GMXSMDF directory            #
     
 $install_dir = "/your_path/GMXSMDF";
######################## !!! End of customize settings !!! ##########################

if($install_dir eq "/your_path/GMXSMDF")
{# user forgets to set the default path of GMXSMDF, try to solve this problem
    $install_dir = getcwd;
...
if(!-s $install_dir)
{
	die "The GMXSMDF directory ($install_dir) is not existing, please revise the customize settings part inside the configure.pl, set the path as  your unzipped GMXSMDF directory\n";
}
...
{
        die "\nPlease check the installation directory setting and run the configure program in the installation directory of GMXSMDF.\n";
}
print " OK!\n";
...
if (prompt_yn("GMXSMDF will be installed into <$install_dir> ")){
